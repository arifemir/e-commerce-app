...
router.route('/:id').get(takeTokenGiveUser, checkIsAdmin, getUserById).delete(takeTokenGiveUser, checkIsAdmin, deleteUser).put(takeTokenGiveUser, checkIsAdmin, updateUser);

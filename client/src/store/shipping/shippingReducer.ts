import { ADD_SHIPPING_LOCATION, LOADING_SHIPPING_LOCATION, IShippingActions, IShippingState, ERROR_SHIPPING_LOCATION, DELETE_SHIPPING_LOCATION, SELECT_SHIPPING_LOCATION, GET_SHIPPING_LOCATION } from "./shippingTypes";
